...
<head>
  ...
  <title>Lapak Buku | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>L</b>BU</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Lapak</b>Buku</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $_SESSION['nama_pembeli']; ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo $_SESSION['nama_pembeli']; ?>
                  <small></small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                ...
                <div class="pull-right">
                 <a href="../session/logout" class="btn btn-danger btn-sm">
